...
// use crate::three_addr_code_ir::{
//     RValueF, RValueI, LValueF, LValueI, TempF, TempI,
// };
...
//     ) -> (Register, TinyCode) {
//         match operand {
//             RValueI::LValue(lval) => match lval {
//                 LValueI::Temp(temp) => {
...
//     ) -> (Register, TinyCode) {
//         match operand {
//             RValueF::LValue(lval) => match lval {
//                 LValueF::Temp(temp) => {
...
//     fn integer_binary_op_tac_operand_to_opmrl(operand: RValueI) -> OpmrL {
//         match operand {
//             RValueI::LValue(lval) => match lval {
//                 LValueI::Temp(temp) => {
//                     let existing_reg = *INT_REGISTER_MAP.borrow().get(&temp).unwrap();
...
//             },
//             RValueI::RValue(n) => OpmrL::Int(OpmrIL::Literal(n)),
//         }
//     }
//
//     // TODO [idiomatic rust]: Can this be changed to TryFrom impls
//     fn float_binary_op_tac_operand_to_opmrl(operand: RValueF) -> OpmrL {
//         match operand {
//             RValueF::LValue(lval) => match lval {
//                 LValueF::Temp(temp) => {
//                     let existing_reg = *FLOAT_REGISTER_MAP.borrow().get(&temp).unwrap();
...
//             },
//             RValueF::RValue(n) => OpmrL::Float(OpmrFL::Literal(n)),
//         }
//     }
// }
//
